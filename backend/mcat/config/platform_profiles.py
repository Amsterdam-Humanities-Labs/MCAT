...
No consent cookies are ever shipped as defaults: when a project has no cookies,
the user is asked to Set up browser, which captures consent (and optional login)
into the per-project jar.
